...
/**
 * Append a `[X.Y.Z]: https://github.com/colbymchenry/codegg/releases/tag/vX.Y.Z`
...
function appendLinkRef(text, version) {
  const refLine = `[${version}]: https://github.com/colbymchenry/codegg/releases/tag/v${version}`;
