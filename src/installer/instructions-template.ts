 ...
 *
 * Codegraph used to write a `## CodeGG` usage guide into each
 * agent's instructions file (CLAUDE.md / AGENTS.md / GEMINI.md /
 * codegg.mdc / Kiro steering doc). That duplicated the guidance the
...
export const CODEGG_SECTION_START = '<!-- CODEGG_START -->';
export const CODEGG_SECTION_END = '<!-- CODEGG_END -->';
