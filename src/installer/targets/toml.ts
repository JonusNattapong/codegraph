 ...
 * single dotted-key table block (`[mcp_servers.codegg]`) inside an
 ...
 *
 * Strategy: treat the file as text. Find the `[mcp_servers.codegg]`
 ...
 *     the full dotted key `[mcp_servers.codegg]`).
