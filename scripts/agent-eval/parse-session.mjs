...
const explore = subCounts['mcp__codegraph__codegg_explore'] || mainCounts['mcp__codegraph__codegg_explore'] || 0;
...
console.log(`\nVERDICT: codegg_explore used ${explore}x | Read ${reads} | Grep/Bash ${greps}`);
