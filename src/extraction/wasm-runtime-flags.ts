 ...
 */
const RELAUNCH_GUARD_ENV = 'CODEGG_WASM_RELAUNCHED';
 ...
 */
export const HOST_PPID_ENV = 'CODEGG_HOST_PPID';
 ...
 * disabled via CODEGG_NO_RELAUNCH.
 *
...
export function relaunchWithWasmRuntimeFlagsIfNeeded(scriptPath: string): void {
  ...
  if (process.env.CODEGG_NO_RELAUNCH) return;
